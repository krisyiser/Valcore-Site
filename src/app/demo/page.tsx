...
export const metadata: Metadata = {
  title: 'Solicitar Evaluación Técnica | VALCORE',
  description: 'Inicie una evaluación técnica con el equipo de ingeniería de infraestructura de Valcore.',
  alternates: { canonical: 'https://valcore.mx/demo' }
}

/**
 * @description Ruta alternativa para la evaluación técnica corporativa de Valcore.
 */
